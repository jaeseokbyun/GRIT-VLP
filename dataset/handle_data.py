...
from dataset.caption_dataset import re_train_dataset, re_eval_dataset, pretrain_dataset, nlvr_pretrain_dataset
from dataset.nlvr_dataset import nlvr_dataset
from dataset.vqa_dataset import vqa_dataset
import math
from dataset.randaugment import RandomAugment
from dataset.sampler_for_grit import Sampler_for_GRIT
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        ...
        dataset = nlvr_pretrain_dataset(config['train_file'], pretrain_transform)                  
        return dataset      
